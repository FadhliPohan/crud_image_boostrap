                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nama_pembeli" class="form-control" id="nama_pembeli"
                                placeholder="Nama pembeli" value="{{ $pembeli->nama_pembeli }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="6" name="alamat_pembeli" class="form-control" id="alamat_pembeli"
                                placeholder="Harap Alamat dengan lengkap!" value="">{{ $pembeli->alamat_pembeli }}</textarea>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" name="NIK" id="NIK" class="form-control"
                                placeholder="Isikan NIK anda" maxlength="13" value="{{ $pembeli->NIK }}">
                        </div>
                        <div class="form-group col-sm-4">
