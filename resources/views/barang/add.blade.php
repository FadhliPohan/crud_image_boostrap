                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="harga_barang" id="harga_barang" class="form-control"
                                placeholder="Harga Barang" maxlength="13" value="">

                        </div>
                        <div class="form-group col-sm-6">
                            <label for="qty_barang">Jumlah Barang</label>
                            <input type="text" name="qty_barang" id="qty_barang" class="form-control"
                                placeholder="Jumlah Barang" value="">

                        </div>
                    </div>

                    <div class="form-actions">
                        <button href="{{ Route('barang.index') }}" class="btn btn-info mt-2"><i
